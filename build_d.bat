...
call gn gen out/debug --sln=angle-debug --ide=vs2022 "--args=is_debug=true is_clang=false target_cpu=\"x86\" treat_warnings_as_errors=false angle_enable_vulkan=false angle_enable_gl=false"
